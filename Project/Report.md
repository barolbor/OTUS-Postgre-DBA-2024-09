...
### <a id="patroni_inside">Принцип работы Patroni</a>
[Вернуться к содержанию](#content) 

#### <a id="patroni_inside_cycle">Цикл Patroni</a>
...
#### <a id="patroni_inside_elections">Перевыборы мастера</a>
[Вернуться к содержанию](#content) 
...
### <a id="choose_cluster_config">Выбор конфигурации кластера</a>
[Вернуться к содержанию](#content) 
...
![Cluster](images/patroni_failover_cluster_01.png)





### <a id="cluster_install">Установка и настройка кластера</a>
...
#### <a id="cluster_install_consul">Установка Consul</a>
...
#### <a id="cluster_install_postgresql">Установка PostgreSQL</a>
...
#### <a id="cluster_install_patroni">Установка Patroni</a>
...
### <a id="cluster_install_haproxy">Установка HAProxy</a>
...
#### <a id="cluster_install_keepalived">Установка KeepAlived</a>
...
#### <a id="ref_list">Список использованной литературы, статей, ресурсов</a>
